	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
		...
		<div class="bhoechie-tab-content">
			...
			<hr>
				<div id="pricing_table_template">
					<div class="row">
						...
						<div class="col-md-3">
							...
							<label for="pricing_table_design_one" class="pricing_layout_one"><img src="<?php echo APT_PLUGIN_URL . "assets/img/1.png"?>" style="box-shadow: 3px 2px 11px 0px #999;">
							</label> 
						</div>
						<div class="col-md-3">
							...
							<label for="pricing_table_design_two" class="pricing_layout_two" ><img src="<?php echo APT_PLUGIN_URL . "assets/img/2.png"?>" style="box-shadow: 3px 2px 11px 0px #999;">
							</label>
						</div>
						<div class="col-md-3">
							...
							<label for="pricing_table_design_three" class="pricing_layout_three" ><img src="<?php echo APT_PLUGIN_URL . "assets/img/3.png"?>" style="box-shadow: 3px 2px 11px 0px #999;">
							</label>
						</div>
						<div class="col-md-3">
							...
							<label for="pricing_table_design_four" class="pricing_table_four" ><img src="<?php echo APT_PLUGIN_URL . "assets/img/4.png"?>" style="box-shadow: 3px 2px 11px 0px #999;">
							</label>
						</div>
					</div>
					<hr>
				...
				<div class="row pro-feature">
					...
					<img src="<?php echo APT_PLUGIN_URL . "assets/img/set1.png"?>">
					<img src="<?php echo APT_PLUGIN_URL . "assets/img/set2.png"?>">
					<img src="<?php echo APT_PLUGIN_URL . "assets/img/set3.png"?>">
					<img src="<?php echo APT_PLUGIN_URL . "assets/img/set4.png"?>">
				</div>
		</div>
		...
		<div class="bhoechie-tab-content">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="ma_field p-4">
						<?php if(isset($pricing_post_settings['total_cols'])) $total_cols = $pricing_post_settings['total_cols']; else $total_cols = "col-md-4"; ?>
			...
			<div class="row pro-feature">
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php _e('Heading Font Size', APT_TXTDM); ?> <span style="color:red; font-size: 20px;">(Pro)</span></h5>
						<p><?php _e('Pricing Heading Name Font Size.', APT_TXTDM); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						<?php if(isset($pricing_post_settings['apt_heading_size'])) $apt_heading_size = $pricing_post_settings['apt_heading_size']; else $apt_heading_size = "20"; ?>
						<input type="range" class="custom-range" id="apt_heading_size1" name="apt_heading_size" min="10" max="50" value="<?php echo $apt_heading_size; ?>" onchange="return display_range_value(this.id, this.value);">
						<span id="apt_heading_size1-value" class="badge badge-info pt-2 pb-2 pr-2 pl-2"><?php echo $apt_heading_size; ?></span>
					</div>
				</div>
			</div>
			<div class="row pro-feature">
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php _e('Feature Font Size', APT_TXTDM); ?> <span style="color:red; font-size: 20px;">(Pro)</span></h5>
						<p><?php _e('Pricing Table [Features] Font Size.', APT_TXTDM); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						<?php if(isset($pricing_post_settings['apt_feature_size'])) $apt_feature_size = $pricing_post_settings['apt_feature_size']; else $apt_feature_size = "16"; ?>
						<input type="range" class="custom-range" id="apt_feature_size1" name="apt_feature_size" min="10" max="50" value="<?php echo $apt_feature_size; ?>" onchange="return display_range_value(this.id, this.value);">
						<span id="apt_feature_size1-value" class="badge badge-info pt-2 pb-2 pr-2 pl-2"><?php echo $apt_feature_size; ?></span>
					</div>
				</div>
			</div>
			<div class="row pro-feature">
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php _e('Button Text Font Size', APT_TXTDM); ?> <span style="color:red; font-size: 20px;">(Pro)</span></h5>
						<p><?php _e('Pricing Button Text Font Size.', APT_TXTDM); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
						<?php if(isset($pricing_post_settings['apt_button_size'])) $apt_button_size = $pricing_post_settings['apt_button_size']; else $apt_button_size = "13"; ?>
						<input type="range" class="custom-range" id="apt_button_size1" name="apt_button_size" min="10" max="50" value="<?php echo $apt_button_size; ?>" onchange="return display_range_value(this.id, this.value);">
						<span id="apt_button_size1-value" class="badge badge-info pt-2 pb-2 pr-2 pl-2"><?php echo $apt_button_size; ?></span>
					</div>
				</div>
			</div>
			...
			<div class="row pricing_iconpicker">
				<div class="col-md-4">
					<div class="ma_field_discription">
						...
						<p><?php _e('Select Pricing Header Icon ', APT_TXTDM); ?></p> 
					</div>
				</div>
				<div class="col-md-8">
		...
		<div class="bhoechie-tab-content">
			...
			<div class="row pro-feature">
				<div class="col-md-2">
					<div class="ma_field_discription">
						<h5><?php _e('Features Text Color', APT_TXTDM); ?> <span style="color:red; font-size: 20px;">(Pro)</span></h5>
					</div>
				</div>
				<div class="col-md-4 pro-disable">
					<div class="ma_field">
						<?php if(isset($pricing_post_settings['apt_feature_color'])) $apt_feature_color = $pricing_post_settings['apt_feature_color']; else $apt_feature_color = "#fff"; ?>
						<input type="text" id="apt_feature_color" name="apt_feature_color" value="<?php echo $apt_feature_color; ?>" default-color="<?php echo $apt_feature_color; ?>">
					</div>
				</div>
				<div class="col-md-2 pro-icon">
					<div class="ma_field_discription">
						<h5><?php _e('Icon Color', APT_TXTDM); ?> <span style="color:red; font-size: 20px;">(Pro)</span></h5>
					</div>
				</div>
				<div class="col-md-4 pro-icon pro-disable">
					<div class="ma_field">
						<?php if(isset($pricing_post_settings['apt_icon_color'])) $apt_icon_color = $pricing_post_settings['apt_icon_color']; else $apt_icon_color = "#fff"; ?>
						<input type="text" id="apt_icon_color" name="apt_icon_color" value="<?php echo $apt_icon_color; ?>" default-color="<?php echo $apt_icon_color; ?>">
					</div>
				</div>
		...
		<div class="bhoechie-tab-content">
			...
			<div class="row pro-feature">
				...
				<div class="col-md-4 pro-disable">
					<div class="ma_field">
						<?php if(isset($pricing_post_settings['apt_featured_text_color'])) $apt_featured_text_color = $pricing_post_settings['apt_featured_text_color']; else $apt_featured_text_color = "#fff"; ?>
						<input type="text" id="apt_featured_text_color" name="apt_featured_text_color" value="<?php echo $apt_featured_text_color; ?>" default-color="<?php echo $apt_featured_text_color; ?>">
					</div>
				</div>
				<div class="col-md-2 pro-icon">
					<div class="ma_field_discription">
				...
				<div class="col-md-4 pro-icon pro-disable">
					<div class="ma_field">
						<?php if(isset($pricing_post_settings['apt_featured_icon_color'])) $apt_featured_icon_color = $pricing_post_settings['apt_featured_icon_color']; else $apt_featured_icon_color = "#fff"; ?>
						<input type="text" id="apt_featured_icon_color" name="apt_featured_icon_color" value="<?php echo $apt_featured_icon_color; ?>" default-color="<?php echo $apt_featured_icon_color; ?>">
					</div>
				</div>
		...
		<div class="bhoechie-tab-content">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="ma_field_discription">
						<h5><?php _e('Apply own css on Pricing Table and dont use style tag', APT_TXTDM); ?></h5>
					</div>
				</div>
				<div class="col-md-8">
					<div class="ma_field p-4">
